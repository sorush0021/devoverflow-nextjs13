  ...
  const handleTagRemove = (tag: string , field: any)=>{
    ...
    return (
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex w-full flex-col'>
                  ...
                  text-dark400_light800'>Question Title<span className='text-primary-500'>*</span></FormLabel>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex w-full flex-col gap-3'>
                  <FormLabel className='paragraph-semibold
                  text-dark400_light800'>Detailed explanation of your problem<span className='text-primary-500'>*</span></FormLabel>
                  <FormControl className='mt-3.5'>
                  <Editor
        apiKey={process.env.NEXT_PUBLIC_TINY_EDITIOR_API_KEY}
        onInit={(_evt, editor) => {
            // @ts-ignore
      ...
      />
                  ...
                  <FormDescription className='body-regular mt-2.5
                  text-light-500'>
                   Intoduce the problem and expand on what you put in the title. minimum 20 characters.
                  </FormDescription>
                  <FormMessage  className='text-red-500'/>
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex w-full flex-col'>
                  <FormLabel className='paragraph-semibold
                  text-dark400_light800'>Tags<span className='text-primary-500'>*</span></FormLabel>
                  <FormControl className='mt-3.5'>
                    <>
                    <Input 
                    className='no-focus paragraph-regular
                    ...
                    {field.value.length >0 && (
                        <div className='flex-start mt-2.5 gap-2.5'>
                           {field.value.map((tag:any)=>(
                            ...
                            px-4 py-2 capitalize' onClick={()=>handleTagRemove(tag , field)}>
                                 {tag}
                                 <Image
