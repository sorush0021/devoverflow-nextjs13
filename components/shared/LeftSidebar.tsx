    ...
    dark:shadow-none max-sm:hidden lg:w-[266px] '>
            ...
            {sidebarLinks.map((Item)=>{
                ...
                return(
                     ...
                     <Link  key={Item.route} href={Item.route} className={`${isActive ? 'primary-gradient rounded-lg text-light-900'
          ...
          <div className="flex flex-col gap-3">
              ...
              <Link href="/sign-in">
                <Button className="small-medium btn-secondary
                 min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none ">
                    ...
                    alt='login' width={20} height={20} className="invert-color lg:hidden"/>
              ...
              <Link href="/sign-up">
                ...
                <Image src='/assets/icons/sign-up.svg'
                    alt='sign up' width={20} height={20} className="invert-color lg:hidden"/>
